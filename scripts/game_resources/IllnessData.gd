...
var name: String
var info: Dictionary
var matching_rules: Dictionary

func _init(initial_name: String, initial_info: Dictionary, initial_matching_rules: Dictionary) -> void:
	self.name = initial_name
	self.info = initial_info
	self.matching_rules = initial_matching_rules
