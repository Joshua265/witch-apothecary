...
static var ACTIONS: Dictionary[String, ActionData] = {
	...
	"ask_short_breath": ActionData.new("Do you feel short of breath?", "question", "Helena reports experiencing shortness of breath, particularly after exertion, which may be related to overexertion or stress.", "Do you feel short of breath?"),
