...
#TODO: add more for the next level - second patient (prob: var illnesses_2 that use the vafr illnesses + more added)
# for info --- the blood pressure is not relevant for any of these - maybe add like heartatack 
# or hypertention for the next level (see end of file) - i'll the code for the highlighting but its not meaningful right now
#TODO: add the treatment for the dialog after chossing the diagnosis also here - get it through a method prob
var illnesses = [
	{
	...
	},
	{
		...
		"matching_rules": {
			...
			"experiences shortness of breath": true, #TODO: clean up
			"sweating": true,
			"restlessness": true,
			"stress": true
		}
...
#{
	...
	#"info": {
		#"Symptoms": "High blood pressure may present with headache, blurred vision, and occasional nosebleeds.",
		#"Diagnosis": "Elevated blood pressure readings on multiple occasions confirm hypertension.",
		#"Treatment": "Lifestyle modifications (diet, exercise) and possibly antihypertensive medications."
	#},
	#"matching_rules": {
		#"headache": true,
		#"blood_pressure": { "min_sys": "140 mmHg" }
	#}
#},
